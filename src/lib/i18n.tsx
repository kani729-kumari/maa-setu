...
const dict: Dict = {
  ...
  demoMode: ["PROTOTYPE", "प्रोटोटाइप"],
  demoData: ["Prototype Data", "प्रोटोटाइप डेटा"],
  demoJourney: ["Guided Journey", "निर्देशित यात्रा"],
  ...
  demoCreds: ["Login Credentials", "लॉगिन जानकारी"],
